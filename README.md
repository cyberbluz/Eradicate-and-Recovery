...
## I also worked through several Brute Force Attempt alerts and found many were duplicates involving the same ip, but none successfully breached the network.  I carefully mapped the ip addresses looking for connections that would indicate a botnet DDos attack was employed.  Finding no evidence of a DDos attack, I closed out the remaining alerts and continued to harden the NSG. 
